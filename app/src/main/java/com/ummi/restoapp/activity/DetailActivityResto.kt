package com.ummi.restoapp.activity
...
import com.ummi.restoapp.activity.adapter.HighLightAdapter
import com.ummi.restoapp.activity.adapter.ReviewAdapter
import com.ummi.restoapp.activity.api.ApiEndpoint
import com.ummi.restoapp.activity.model.ModelHighLights
import com.ummi.restoapp.activity.model.ModelMain
import com.ummi.restoapp.activity.model.ModelReview
import kotlinx.android.synthetic.main.activity_detail_resto.*
import org.json.JSONException
import org.json.JSONObject

class DetailActivityResto : AppCompatActivity() {

    private var mProgressBar: ProgressDialog? = null
    private var highlightsAdapter: HighLightAdapter? = null
    ...
    private fun showRecyclerViewList() {
        highlightsAdapter = HighLightAdapter(modelHighlights)
    ...
    private fun getDetailResto() {
        ...
        AndroidNetworking.get(ApiEndpoint.BASEURL + ApiEndpoint.DetailRestaurant + IdResto)
            .addHeaders("user-key", "770f259f060388472493013ac6604ec0")
            ...
            .getAsJSONObject(object : JSONObjectRequestListener {
                ...
                override fun onResponse(response: JSONObject) {
                    try {
                        ...
                        e.printStackTrace()
                        Toast.makeText(this@DetailActivityResto,
            ...
            .getAsJSONObject(object : JSONObjectRequestListener {
                override fun onResponse(response: JSONObject) {
                    try {
                        ...
                        e.printStackTrace()
                        Toast.makeText(this@DetailActivityResto, "Gagal menampilkan data!", Toast.LENGTH_SHORT).show()
                    }
                }

                override fun onError(anError: ANError) {
                    mProgressBar?.dismiss()
                    Toast.makeText(this@DetailActivityResto, "Tidak ada jaringan internet!", Toast.LENGTH_SHORT).show()
                }
            })
    }
