...
import com.ummi.restoapp.activity.adapter.MainAdapter
import com.ummi.restoapp.activity.adapter.MainAdapterHorizontal
import com.ummi.restoapp.activity.api.ApiEndpoint
import com.ummi.restoapp.activity.model.ModelMain
import com.ummi.restoapp.activity.model.ModelMainHorizontal
import com.ummi.restoapp.activity.utils.OnItemClickCallBack
    ...
    private fun showRecyclerResto() {
        ...
        mainAdapter?.setOnItemClickCallback(object : OnItemClickCallBack {
            override fun onItemMainClicked(modelMain: ModelMain?) {
                val intent = Intent(this@MainActivity, DetailActivityResto::class.java)
                intent.putExtra(DetailActivityResto.DETAIL_RESTO, modelMain)
